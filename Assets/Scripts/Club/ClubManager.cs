...
//    public SendCoinTopPanel sendCoinTopPanel;
    ...
    public SendMeberDiamondTopPanel sendMeberDiamondTopPanel;
    //通用弹窗
    ...
    private void Awake()
    {
       ...
       // sendCoinTopPanel = containerTop.Find("SendCoinTopPanel").GetComponent<SendCoinTopPanel>();
        sendMeberDiamondTopPanel = containerTop.Find("SendMeberDiamondTopPanel").GetComponent<SendMeberDiamondTopPanel>();
