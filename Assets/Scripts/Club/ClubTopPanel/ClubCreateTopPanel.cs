...
public class ClubCreateTopPanel : BasePlane
{
    ...
    void Awake()
    {
		...
		completeBtn= transform.Find("ToggleGroup/saveBtn").GetComponent<Button>();
        title = transform.Find("ToggleGroup/Title").gameObject;
      

        clubHead = transform.Find("ClubHead/mask/head").GetComponent<Image>();
    ...
    public void GetDiamondCost(Hashtable data) {
        coinTip.text =data["DiamondCost"].ToString();
    ...
    public override void OnAddComplete()
    {
        ...
        //获取个人中心的金币
        curCoin.text = StaticData.diamond+"";
    }
