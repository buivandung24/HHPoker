...
public class ScoreDetailTopPanel : BasePlane {
    ...
    private CircleImage[] images=new CircleImage[3];
    private Text Name;
    private Text Desk;
    private Text Time;
    private Text Mang;
    ...
    private void Awake()
    {
        ...
        images[0] = panels[0].transform.Find("Mvp/Icon").GetComponent<CircleImage>();
        images[1] = panels[0].transform.Find("Mvp/Icon2").GetComponent<CircleImage>();
        images[2] = panels[0].transform.Find("Mvp/Icon3").GetComponent<CircleImage>();
//        images[3] = panels[0].transform.Find("Mvp/Icon4").GetComponent<CircleImage>();
    ...
    {
        GameTools.GetSingleton().GetTextureFromNet(data["mvpUrl"].ToString(), GetNetSprite1);
        images[0].transform.GetChild(1).GetComponent<Text>().text = data["mvpname"].ToString();
        GameTools.GetSingleton().GetTextureFromNet(data["fishUrl"].ToString(), GetNetSprite2);
        images[1].transform.GetChild(1).GetComponent<Text>().text = data["fishname"].ToString();
        GameTools.GetSingleton().GetTextureFromNet(data["richUrl"].ToString(), GetNetSprite3);
        images[2].transform.GetChild(1).GetComponent<Text>().text = data["richname"].ToString();
...
//        images[3].transform.GetChild(2).GetComponent<Text>().text = data["modelname"].ToString();
    ...
    private void GetNetSprite1(Sprite sprite)
    {
        images[0].sprite = sprite;
    }
    private void GetNetSprite2(Sprite sprite)
    {
        images[1].sprite = sprite;
    }
    private void GetNetSprite3(Sprite sprite)
    {
