...
public class GuessHandPopup : BasePopup {
    ...
    void Awake() {
        ...
        betItems[0].btn.onClick.AddListener(()=> { SelectBtnFun(betItems,0); });
        betItems[1].btn.onClick.AddListener(() => { SelectBtnFun(betItems, 1); });
        betItems[2].btn.onClick.AddListener(() => { SelectBtnFun(betItems, 2); });
        betItems[3].btn.onClick.AddListener(() => { SelectBtnFun(betItems, 3); });
        betItems[4].btn.onClick.AddListener(() => { SelectBtnFun(betItems, 4); });

        chooseCoinItems[0].btn.onClick.AddListener(() => { SelectBtnFun(chooseCoinItems, 0); });
        chooseCoinItems[1].btn.onClick.AddListener(() => { SelectBtnFun(chooseCoinItems, 1); });
        chooseCoinItems[2].btn.onClick.AddListener(() => { SelectBtnFun(chooseCoinItems, 2); });
        chooseCoinItems[3].btn.onClick.AddListener(() => { SelectBtnFun(chooseCoinItems, 3); });
